...
class LessonController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return $lesson->response()->setStatusCode(200, "Lesson rturned succesfully")->header('Additional header', 'true');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return $lesson->response()->setStatusCode(200, "Lesson Updated Succesfully");
    }
