...
class TagController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return $tag->response()->setStatusCode(200, "Tag rturned succesfully")->header('Additional header', 'true');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return $tag->response()->setStatusCode(200, "Tag Updated Succesfully");
    }
